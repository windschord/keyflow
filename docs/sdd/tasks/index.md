...
| Phase 15: UI/UX改善（2026-07-07） | 0 | 1 | 9 | 0 | [詳細](phase-15/) @phase-15/ |
...
| タスクID | タイトル | ステータス | 依存 | 見積 | 詳細リンク |
|----------|---------|-----------|------|------|-----------|
| TASK-068 | アプリのブランディング（アイコン生成・ウィンドウタイトル） | IN_PROGRESS | - | 60min | [詳細](phase-15/TASK-068.md) @phase-15/TASK-068.md |
