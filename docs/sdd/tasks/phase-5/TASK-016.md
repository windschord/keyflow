...
- [x] MIDIキーボードで音を押すと楽譜カーソルが移動する（手動E2E確認）
- [x] 正しい音を押すと鍵盤が黄色にハイライトされる
- [x] 誤った音を押すと鍵盤が赤にハイライトされる
- [x] MIDIデバイスなしの場合も画面鍵盤クリックで練習できる
- [x] `useMidi` がコンポーネントアンマウント時にイベントリスナーを解除する
